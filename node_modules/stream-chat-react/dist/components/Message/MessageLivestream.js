...
var MessageLivestreamWithContext = function (props) {
    ...
    var _m = useComponentContext().QuotedMessage, QuotedMessage = _m === void 0 ? DefaultQuotedMessage : _m;
    var _o = useComponentContext(), Attachment = _o.Attachment, _p = _o.Avatar, Avatar = _p === void 0 ? DefaultAvatar : _p, _q = _o.EditMessageInput, EditMessageInput = _q === void 0 ? DefaultEditMessageForm : _q, _r = _o.MessageDeleted, MessageDeleted = _r === void 0 ? DefaultMessageDeleted : _r, _s = _o.MessageRepliesCountButton, MessageRepliesCountButton = _s === void 0 ? DefaultMessageRepliesCountButton : _s, _t = _o.PinIndicator, PinIndicator = _t === void 0 ? DefaultPinIndicator : _t, _u = _o.ReactionsList, ReactionsList = _u === void 0 ? DefaultReactionsList : _u, _v = _o.ReactionSelector, ReactionSelector = _v === void 0 ? DefaultReactionSelector : _v;
